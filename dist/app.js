...
$templateCache.put('app/twang/dashboard/dashboard.channel.list.html','<h3 class="heading">Channels</h3>\r\n<md-divider></md-divider>\r\n<md-card ng-repeat="stream in vm.streams">\r\n    <img class="md-card-image" ng-src="{{ stream.preview.medium }}">\r\n    <md-card-header>\r\n        <md-card-avatar>\r\n            <img ng-src="{{ stream.channel.logo }}">\r\n        </md-card-avatar>\r\n        <md-card-header-text>\r\n            <span class="md-title">{{ stream.channel.display_name }}</span>\r\n            <span class="md-subhead">{{ stream.viewers }} viewers</span>\r\n            <span class="md-subhead">{{ stream.viewers }} viewers</span>\r\n        </md-card-header-text>\r\n    </md-card-header>\r\n    <md-card-title style="padding-top: 0">\r\n        <md-card-title-text>\r\n            <span class="md-headline">{{ stream.game }}</span>\r\n        </md-card-title-text>\r\n    </md-card-title>\r\n    <md-card-content>{{ stream.channel.status }}</md-card-content>\r\n    <md-card-actions layout="row" layout-align="end center">\r\n        <md-button href="{{ stream.channel.url }}" target="_blank">View</md-button>\r\n    </md-card-actions>\r\n</md-card>');
$templateCache.put('app/twang/dashboard/dashboard.game.html','<h4 class="heading" ng-class="{ \'ng-hide\': vm.streams.length == 0 }">{{ vm.game.name }}</h4>\r\n<div ng-class="{ \'ng-hide\': vm.streams.length == 0 }" layout="row" layout-sm="column" layout-xs="column">\r\n    <div flex flex-gt-sm="50" flex-gt-md="25" ng-repeat="stream in vm.streams">\r\n        <md-card>\r\n            <img class="md-card-image" ng-src="{{ stream.preview.medium }}">\r\n            <md-card-header>\r\n                <md-card-avatar>\r\n                    <img ng-src="{{ stream.channel.logo }}">\r\n                </md-card-avatar>\r\n                <md-card-header-text>\r\n                    <span class="md-title">{{ stream.channel.display_name }}</span>\r\n                    <span class="md-subhead">{{ stream.viewers }} viewers</span>\r\n                </md-card-header-text>\r\n            </md-card-header>\r\n            <md-card-actions layout="row" layout-align="end center">\r\n                <md-button href="{{ stream.channel.url }}" target="_blank">View</md-button>\r\n            </md-card-actions>\r\n        </md-card>\r\n    </div>\r\n</div>\r\n');
$templateCache.put('app/twang/dashboard/dashboard.game.list.html','<h3 class="heading">Games</h3>\r\n<md-divider></md-divider>\r\n<dashboard-game game="game" ng-repeat="game in vm.games | orderBy:\'name\'">\r\n</dashboard-game>\r\n\r\n');
