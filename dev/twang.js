...
var Dashboard_1 = __webpack_require__(/*! Pages/Dashboard */ "./src/Pages/Dashboard.ts");
var LoginResult_1 = __webpack_require__(/*! Pages/LoginResult */ "./src/Pages/LoginResult.ts");
m.route(document.body, '/', {
    '/': { render: function () { return m(Layout_1.Layout, m(Dashboard_1.Dashboard)); } },
    '/loginresult': { render: function () { return m(LoginResult_1.LoginResult); } },
});
...
var Autocomplete = /** @class */ (function () {
    ...
    Autocomplete.prototype.oninit = function (vnode) {
        var _this = this;
        this.delayedSearch = Debounce_1.debounce(function () {
            _this.triggerSearch(vnode);
        }, 150);
    };
    Autocomplete.prototype.view = function (vnode) {
        return m('div', {
    ...
    Autocomplete.prototype.renderInput = function (vnode) {
        var _this = this;
        ...
        return m('input', {
            ...
            onfocus: function () { _this.triggerSearch(vnode); },
            onblur: function () {
                var selectOnBlur = vnode.attrs.selectOnBlur !== false;
                if (_this.showSuggestions && selectOnBlur) {
                    _this.selectCurrent(vnode);
                }
                _this.showSuggestions = false;
            },
            oninput: function (event) {
                _this.filter = event.srcElement.value;
                _this.delayedSearch();
                event.redraw = false;
            },
            onkeydown: function (event) { return _this.keydown(event, vnode); },
            onchange: function (event) { return _this.selectCurrent(vnode); }
        });
    };
    Autocomplete.prototype.renderSuggestions = function (vnode) {
        var _this = this;
        ...
        this.items.forEach(function (item, index) {
            ...
            }, vnode.attrs.renderItem(item, _this.filter)));
        });
        return m('div', {
            class: 'autocomplete__suggestions'
        }, suggestions);
    };
    Autocomplete.prototype.keydown = function (event, vnode) {
        // Escape (27)
        if (event.keyCode === 27) {
            this.filter = vnode.attrs.displayName(vnode.attrs.value);
            this.showSuggestions = false;
    ...
    Autocomplete.prototype.triggerSearch = function (vnode) {
        var _this = this;
        if (!this.filter) {
            return;
        }
    ...
    Autocomplete.prototype.selectCurrent = function (vnode) {
        if (!this.showSuggestions) {
            return;
        }
        var current = null;
...
var GameList = /** @class */ (function () {
    ...
    GameList.prototype.item = function (name) {
        var _this = this;
        return m('.game-list__item', [
            ...
            m('button.game-list__remove', {
                onclick: function () { return _this.remove(name); }
            }, m(Trash_1.Trash))
        ]);
    };
    GameList.prototype.add = function (game) {
        var index = this.games.indexOf(game.name);
        if (index !== -1) {
            return;
        }
        this.games.push(game.name);
        this.games.sort(function (a, b) { return (a || '').localeCompare(b, 'en', { numeric: true }); });
    };
    GameList.prototype.remove = function (name) {
        var index = this.games.indexOf(name);
...
var GameSearch = /** @class */ (function () {
    function GameSearch() {
    }
    GameSearch.prototype.view = function (vnode) {
        return m(Autocomplete_1.Autocomplete, {
...
function renderCountry(game, filter) {
    return displayName(game);
}
function search(filter) {
    return Twitch_1.Twitch.searchGames(filter);
}
...
var children;
var ModalContainer = {
    view: function () { return children; }
};
var Modal = /** @class */ (function () {
    function Modal() {
    }
    Modal.prototype.oncreate = function (vnode) {
    ...
    Modal.prototype.onbeforeupdate = function (vnode) {
        children = vnode.children;
    };
    Modal.prototype.onbeforeremove = function (vnode) {
...
var StreamCard = /** @class */ (function () {
    ...
    StreamCard.prototype.view = function (vnode) {
        var stream = vnode.attrs;
        if (!stream.id) {
...
var StreamList = /** @class */ (function () {
    ...
    StreamList.prototype.view = function (vnode) {
        var streams = vnode.attrs.streams;
        var loading = streams == null;
        var empty = !loading && streams.length === 0;
        var modifiers = loading ? 'stream-list--loading' : (empty ? 'stream-list--empty' : '');
...
/***/ "./src/Icons/Solid/svgs/trash.svg":
/*!****************************************!*\
  !*** ./src/Icons/Solid/svgs/trash.svg ***!
  \****************************************/
/*! no static exports found */
...
module.exports = "<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 448 512\"><path d=\"M432 32H312l-9.4-18.7A24 24 0 0 0 281.1 0H166.8a23.72 23.72 0 0 0-21.4 13.3L136 32H16A16 16 0 0 0 0 48v32a16 16 0 0 0 16 16h416a16 16 0 0 0 16-16V48a16 16 0 0 0-16-16zM53.2 467a48 48 0 0 0 47.9 45h245.8a48 48 0 0 0 47.9-45L416 128H32z\"></path></svg>"
...
var LoginResult = /** @class */ (function () {
    ...
    LoginResult.prototype.view = function () {
        if (Auth_1.Auth.access_token()) {
            Twitch_1.Twitch.revoke(Auth_1.Auth.access_token());
        }
        Auth_1.Auth.clear();
        var index = window.location.href.lastIndexOf('#');
        var queryString = window.location.href.substring(index + 1);
        var resonse = m.parseQueryString(queryString);
        Auth_1.Auth.access_token(resonse.access_token);
        m.route.set('/');
        return [];
    };
    return LoginResult;
...
var Auth = /** @class */ (function () {
    ...
    Auth.access_token = function (value) {
...
var Twitch = /** @class */ (function () {
    ...
    Twitch.loginUrl = function () {
        ...
        var redirectUri = '&redirect_uri=http%3A%2F%2Flocalhost%2Ftwang%2Fdev%2F%23!%2Floginresult';
    ...
    Twitch.revoke = function (access_token) {
        ...
        var base = 'https://id.twitch.tv/oauth2/revoke';
...
var TwitchApiV5 = /** @class */ (function () {
    function TwitchApiV5(client_id, access_token) {
    ...
    TwitchApiV5.prototype.getGameStreams = function (name) {
        return this.__streams(name, 'live', 6, 0)
            .then(function (response) {
            return response.streams.map(mapTwitchStream);
        });
    };
    TwitchApiV5.prototype.searchGames = function (query) {
        return this.__searchGames(query)
            .then(function (response) {
            return (response.games || []).map(mapTwitchGame);
        });
    };
    TwitchApiV5.prototype.__streams = function (game, stream_type, limit, offset) {
    ...
    TwitchApiV5.prototype.__streamsFollowed = function (stream_type, limit, offset) {
        return this.get('streams/followed', {
            stream_type: stream_type,
            limit: limit,
            offset: offset
        });
    };
    TwitchApiV5.prototype.__searchGames = function (query) {
        return this.get('search/games', {
            query: query
        });
    };
    TwitchApiV5.prototype.get = function (endpoint, params) {
        return m.request({
...
function mapTwitchStream(source) {
    return {
        id: '' + source._id,
